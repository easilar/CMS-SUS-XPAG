...
class smsPlotABS(object):
    ...
    def DrawLegend(self):
        ...
        textExtra = rt.TLatex(self.model.Xmin+3*xRange/100, self.model.Ymax-2.90*yRange/100*10, \
                              "m_{#tilde{#chi}_{1}^{#pm}} = 0.5(m_{#tilde{g}}+m_{#tilde{#chi}_{1}^{0}})")
        textExtra.SetTextFont(42)
        textExtra.SetTextSize(0.030)
        textExtra.Draw()
        self.c.textExtra = textExtra
