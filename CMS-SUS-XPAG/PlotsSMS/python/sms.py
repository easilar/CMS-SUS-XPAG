...
class sms():
    ...
    def T5qqqqWW(self):
        ...
        # decay chain
        self.label= "pp #rightarrow #tilde{g} #tilde{g}, #tilde{g} #rightarrow q #bar{q}' W^{#pm} #tilde{#chi}^{0}_{1}"
        # plot boundary. The top 1/4 of the y axis is taken by the legend
        self.Xmin = 600.
        self.Xmax = 2200.
        #self.Xmax = 2100.
        ...
        self.diagOn = False
        # additional label
        self.extraLabel = "m_{#tilde{#chi}_{1}^{\pm}} = 0.5 (m_{#tilde{g}}+m_{#tilde{#chi}_{1}^{0}})"
